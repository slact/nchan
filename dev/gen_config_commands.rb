...
class CfCmd #let's make a DSL!
  ...
  class Cmd
    ...
    def type_line
      lut=OneOf.new(:direct => :NGX_DIRECT_CONF, :main => :NGX_HTTP_MAIN_CONF, :srv => :NGX_HTTP_SRV_CONF, :upstream => :NGX_HTTP_UPS_CONF, :loc => :NGX_HTTP_LOC_CONF, :if => :NGX_HTTP_LIF_CONF)
