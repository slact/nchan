...
The latest Nchan release is v0.92 (December 11, 2015) ([changelog](https://nchan.slact.net/changelog)). This is a *beta* release. There may be some bugs but Nchan is already stable and well-tested.
