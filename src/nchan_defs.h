...
#define NCHAN_DEFAULT_REDIS_NODE_CONNECT_TIMEOUT_MSEC 2000
#define NCHAN_DEFAULT_REDIS_CLUSTER_CONNECT_TIMEOUT_MSEC 15000
#define NCHAN_DEFAULT_REDIS_RECONNECT_DELAY_MSEC 5000
#define NCHAN_DEFAULT_REDIS_CLUSTER_MAX_FAILING_TIME_MSEC 2000
