...
#define DBG(fmt, arg...) ngx_log_error(DEBUG_LEVEL, nchan_error_log(), 0, "SUB:COMMON:" fmt, ##arg)
#define ERR(fmt, arg...) ngx_log_error(NGX_LOG_ERR, nchan_error_log(), 0, "SUB:COMMON:" fmt, ##arg)
