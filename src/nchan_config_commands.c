...
static ngx_command_t  nchan_commands[] = {
  ...
  { ngx_string("nchan_redis_load_scripts_unconditionally"),
    ...
    NULL } ,
  { ngx_string("nchan_redis_load_scripts_unconditionally"), //alt for nchan_redis_load_scripts_unconditionally
    NGX_HTTP_UPS_CONF|NGX_CONF_TAKE1,
    ngx_conf_set_flag_slot,
    NGX_HTTP_SRV_CONF_OFFSET,
    offsetof(nchan_srv_conf_t, redis.load_scripts_unconditionally),
  ...
  { ngx_string("nchan_redis_cluster_max_failing_time"),
    ...
    NULL } ,
  { ngx_string("nchan_redis_node_connect_timeout"), //alt for nchan_redis_cluster_max_failing_time
    NGX_HTTP_UPS_CONF|NGX_CONF_TAKE1,
    ngx_conf_set_msec_slot,
    NGX_HTTP_SRV_CONF_OFFSET,
    offsetof(nchan_srv_conf_t, redis.cluster_max_failing_msec),
  ...
  { ngx_string("nchan_redis_reconnect_delay"),
    ...
    ngx_conf_set_msec_slot,
    NGX_HTTP_SRV_CONF_OFFSET,
    offsetof(nchan_srv_conf_t, redis.reconnect_delay_msec),
    NULL } ,
  { ngx_string("nchan_redis_reconnect_delay"), //alt for nchan_redis_reconnect_delay
    NGX_HTTP_UPS_CONF|NGX_CONF_TAKE1,
    ngx_conf_set_msec_slot,
    NGX_HTTP_SRV_CONF_OFFSET,
    offsetof(nchan_srv_conf_t, redis.reconnect_delay_msec),
  ...
  { ngx_string("nchan_redis_reconnect_delay_jitter"),
    ...
    NGX_HTTP_SRV_CONF_OFFSET,
    offsetof(nchan_srv_conf_t, redis.reconnect_delay_jitter_multiplier),
    NULL } ,
  { ngx_string("nchan_redis_reconnect_delay_jitter"), //alt for nchan_redis_reconnect_delay_jitter
    NGX_HTTP_UPS_CONF|NGX_CONF_TAKE1,
    ngx_conf_set_redis_reconnect_delay_jitter,
    NGX_HTTP_SRV_CONF_OFFSET,
    offsetof(nchan_srv_conf_t, redis.reconnect_delay_jitter_multiplier),
  ...
  { ngx_string("nchan_redis_reconnect_delay_backoff"),
    ...
    NGX_HTTP_SRV_CONF_OFFSET,
    offsetof(nchan_srv_conf_t, redis.reconnect_delay_backoff_multiplier),
    NULL } ,
  { ngx_string("nchan_redis_reconnect_delay_backoff"), //alt for nchan_redis_reconnect_delay_backoff
    NGX_HTTP_UPS_CONF|NGX_CONF_TAKE1,
    ngx_conf_set_redis_reconnect_delay_backoff,
    NGX_HTTP_SRV_CONF_OFFSET,
    offsetof(nchan_srv_conf_t, redis.reconnect_delay_backoff_multiplier),
  ...
  { ngx_string("nchan_redis_reconnect_delay_max"),
    ...
    ngx_conf_set_msec_slot,
    NGX_HTTP_SRV_CONF_OFFSET,
    offsetof(nchan_srv_conf_t, redis.reconnect_delay_max),
    NULL } ,
  { ngx_string("nchan_redis_reconnect_delay_max"), //alt for nchan_redis_reconnect_delay_max
    NGX_HTTP_UPS_CONF|NGX_CONF_TAKE1,
    ngx_conf_set_msec_slot,
    NGX_HTTP_SRV_CONF_OFFSET,
    offsetof(nchan_srv_conf_t, redis.reconnect_delay_max),
